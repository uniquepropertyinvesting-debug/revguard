        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '24px' }}>
              <div style={{
                width: 48, height: 48, background: 'linear-gradient(135deg, #3b82f6, #8b5cf6)',
              ...
              <p style={{ fontSize: '14px', color: 'var(--text-muted)' }}>
                {authMode === 'signup' ? 'Start protecting your revenue in 2 minutes' : 'Sign in to your RevGuard dashboard'}
              </p>
            </div>
            ...
            <form onSubmit={handleAuthSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {authMode === 'signup' && (
                <input
                  ...
                  style={{ width: '100%', padding: '10px 14px', borderRadius: '8px', background: 'var(--bg-primary)', border: '1px solid var(--border)', color: 'var(--text-primary)', fontSize: '14px', boxSizing: 'border-box' }}
                />
              )}
              <input
                type="email"
              ...
              <button
                ...
                className="btn-primary"
                disabled={loading}
                style={{ width: '100%', padding: '12px', fontSize: '15px', fontWeight: 700, borderRadius: '10px', marginTop: '4px' }}
              >
